...
public class ExecuteCommand implements CommandExecutor {
     ...
     */
    @Command(aliases = {"&exec", "&eval"}, description = "Executes java code", usage = "execute <code>")
    public String onCommand(DiscordAPI api, String command, String[] args, Message message, User author) {
